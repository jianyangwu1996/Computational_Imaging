...
def epie_unknown_pos(patterns, guess_obj, guess_probe, guess_positions, n_iter=150, delta=2, nu=30,
                     alpha = 5e-3, beta=8e3, tau=0.1):
    """
